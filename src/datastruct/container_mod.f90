...
module container_mod
  ...
  !! License: GPLv3
  !!
  !! Provides implementations of the [[container_type]] abstract
  ...
  type, extends(container_type) ::  int1_container
    !! Author: Chris MacMackin
    !! Date: December 2015
    !!
  ...
  type, extends(container_type) ::  int2_container
    !! Author: Chris MacMackin
    !! Date: December 2015
    !!
  ...
  type, extends(container_type) ::  int4_container
    !! Author: Chris MacMackin
    !! Date: December 2015
    !!
  ...
  type, extends(container_type) ::  int8_container
    !! Author: Chris MacMackin
    !! Date: December 2015
    !!
  ...
  type, extends(container_type) ::  real_container
    !! Author: Chris MacMackin
    !! Date: December 2015
    !!
  ...
  type, extends(container_type) ::  real4_container
    !! Author: Chris MacMackin
    !! Date: December 2015
    !!
  ...
  type, extends(container_type) ::  real8_container
    !! Author: Chris MacMackin
    !! Date: December 2015
    !!
  ...
  type, extends(container_type) ::  real16_container
    !! Author: Chris MacMackin
    !! Date: December 2015
    !!
  ...
  type, extends(container_type) ::  complex_container
    !! Author: Chris MacMackin
    !! Date: December 2015
    !!
  ...
  type, extends(container_type) ::  complex4_container
    !! Author: Chris MacMackin
    !! Date: December 2015
    !!
  ...
  type, extends(container_type) ::  complex8_container
    !! Author: Chris MacMackin
    !! Date: December 2015
    !!
  ...
  type, extends(container_type) ::  complex16_container
    !! Author: Chris MacMackin
    !! Date: December 2015
    !!
  ...
  type, extends(container_type) ::  logical_container
    !! Author: Chris MacMackin
    !! Date: December 2015
    !!
  ...
  type, extends(container_type) ::  character_container
    !! Author: Chris MacMackin
    !! Date: December 2015
    !!
